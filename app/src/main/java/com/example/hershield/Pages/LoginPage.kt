...
fun LoginPage(
    ...
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(16.dp)
            .background(Color(0xFFFFD1DC)), // Light Pink background color
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
    ) {
        // Shield Icon added above the Login Page text
        Image(
            painter = painterResource(id = R.drawable.shield_icon), // Replace with your actual shield icon resource
            contentDescription = "Shield Icon",
            modifier = Modifier
                .height(100.dp) // Adjust size as needed
                .width(100.dp) // Adjust size as needed
                .padding(bottom = 16.dp) // Add space between the icon and the text
        )
